  ...
  const packages = [
    {
      ...
      description:
        "Complete one-day spiritual journey covering major temples and sacred sites of Vrindavan Dham",
      price: "₹2,100",
      duration: "1 Day",
      image: temp10,
    ...
    },
    {
      ...
      description:
        "Comprehensive spiritual journey covering Vrindavan, Mathura, and Barsana with detailed guidance",
      price: "₹5,100",
      duration: "3 Days",
      popular: true,
      image: temp9,
    ...
    },
    {
      ...
      description:
        "Complete traditional pilgrimage covering all 84 kos of sacred Braj Mandal with experienced guidance",
      price: "₹15,000",
      duration: "7+ Days",
      image: temp3,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Choose from our carefully curated spiritual journey packages
            designed to provide you with the most authentic Vrindavan experience
          </p>
        </div>
